...
supportRouter.get('/agents', authenticate, supportController.getAgents);
...
supportRouter.post('/tickets/:id/assign', authenticate, supportController.assignTicket);
supportRouter.patch('/tickets/:id/resolve', authenticate, supportController.resolveTicket);
